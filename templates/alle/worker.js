...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/alias.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/errors.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/logger.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/query-promise.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/utils.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/pg-core/table.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/pg-core/primary-keys.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sql/expressions/conditions.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sql/expressions/select.js
function asc(column) {
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/relations.js
var Relation = class {
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/selection-proxy.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/foreign-keys.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/unique-constraint.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/columns/common.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/columns/blob.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/columns/custom.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/columns/integer.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/columns/numeric.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/columns/real.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/columns/text.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/columns/all.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/table.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/utils.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/query-builders/delete.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/casing.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/view-base.js
var SQLiteViewBase = class extends View {
  static [entityKind] = "SQLiteViewBase";
};

// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/dialect.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/query-builders/query-builder.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/query-builders/select.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/query-builders/query-builder.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/query-builders/insert.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/query-builders/update.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/query-builders/count.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/query-builders/query.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/query-builders/raw.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/db.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/cache/core/cache.js
var Cache = class {
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/sqlite-core/session.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/d1/session.js
...
// node_modules/.pnpm/drizzle-orm@0.45.2/node_modules/drizzle-orm/d1/driver.js
...
function getAccountCandidates(message, parsed) {
  let emails2 = extractEmailAddresses(headerValue(message.headers, "duck-original-to"));
  if (emails2.length > 0) return emails2;
  emails2 = extractEmailAddresses(headerValue(message.headers, "x-original-to"));
  if (emails2.length > 0) return emails2;
  emails2 = extractEmailAddresses(headerValue(message.headers, "original-recipient"));
  if (emails2.length > 0) return emails2;
  emails2 = extractEmailAddresses(headerValue(message.headers, "x-github-recipient-address"));
  if (emails2.length > 0) return emails2;
  emails2 = extractEmailAddresses(headerValue(message.headers, "destinations"));
  if (emails2.length > 0) return emails2;
  emails2 = extractEmailAddresses(headerValue(message.headers, "resent-to"));
  if (emails2.length > 0) return emails2;
  emails2 = extractEmailAddresses(headerValue(message.headers, "to"));
  if (emails2.length > 0) return emails2;
  emails2 = extractEmailAddresses(formatAddressList(parsed.to));
  if (emails2.length > 0) return emails2;
  emails2 = extractEmailAddresses(message.to);
  if (emails2.length > 0) return emails2;
  emails2 = extractEmailAddresses(parsed.deliveredTo || null);
  if (emails2.length > 0) return emails2;
  emails2 = extractEmailAddresses(headerValue(message.headers, "delivered-to"));
  if (emails2.length > 0) return emails2;
  emails2 = extractEmailAddresses(headerValue(message.headers, "x-forwarded-to"));
  if (emails2.length > 0) return emails2;
  emails2 = extractEmailAddresses(headerValue(message.headers, "x-envelope-to"));
  if (emails2.length > 0) return emails2;
  emails2 = extractEmailAddresses(headerValue(message.headers, "cc"));
  if (emails2.length > 0) return emails2;
  emails2 = extractEmailAddresses(headerValue(message.headers, "bcc"));
  if (emails2.length > 0) return emails2;
  emails2 = extractEmailAddresses(formatAddressList(parsed.cc));
  if (emails2.length > 0) return emails2;
  emails2 = extractEmailAddresses(formatAddressList(parsed.bcc));
  if (emails2.length > 0) return emails2;
  return [];
}
async function emailHandler(message, env, ctx) {
  ...
  try {
    ...
    const matchedAccounts = await db.select({ id: accounts.id, email: accounts.email }).from(accounts).where(inArray(accounts.email, candidateEmails)).all();
    ...
    if (!matchedAccount) {
      ...
      matchedAccount = (created.meta?.changes || 0) > 0 ? { id: accountId, email: accountEmail } : await db.select({ id: accounts.id, email: accounts.email }).from(accounts).where(eq(accounts.email, accountEmail)).get();
    }
    if (!matchedAccount) {
    ...
    try {
      ...
      if (attachmentRows.length > 0) {
        await db.insert(attachments).values(attachmentRows).run();
      }
    } catch (error) {
      if (insertedEmail) {
        try {
...
// worker/route/account.ts
var accountRoutes = new Hono2();
accountRoutes.get("/", async (c) => {
  const db = drizzle(c.env.DB, { schema: schema_exports });
  const items = await db.select().from(accounts).orderBy(asc(accounts.sort_order), asc(accounts.id)).all();
  return c.json({ items });
});
accountRoutes.get("/:id", async (c) => {
  const db = drizzle(c.env.DB, { schema: schema_exports });
  const item = await db.select().from(accounts).where(eq(accounts.id, c.req.param("id"))).get();
...
accountRoutes.put("/sort", async (c) => {
  ...
  const rows = await db.select({
    id: accounts.id
  }).from(accounts).where(inArray(accounts.id, items.map((item) => item.id))).all();
  ...
  for (const item of items) {
    await db.update(accounts).set({ sort_order: item.sort_order }).where(eq(accounts.id, item.id)).run();
  }
  return c.json({
    items: await db.select().from(accounts).where(inArray(accounts.id, items.map((item) => item.id))).orderBy(asc(accounts.sort_order), asc(accounts.id)).all()
  });
});
...
accountRoutes.delete("/:id", async (c) => {
  ...
  }).from(attachments).innerJoin(emails, eq(attachments.email_id, emails.id)).where(eq(emails.account_id, accountId)).all();
  ...
  try {
    ...
    for (let index = 0; index < keys.length; index += 1e3) {
      await c.env.ATTACHMENTS.delete(keys.slice(index, index + 1e3));
    }
  } catch (error) {
...
emailRoutes.get("/", async (c) => {
  ...
  if (keyword) {
    const search = or(
      ...
      like(emails.from_name, `%${keyword}%`),
      like(emails.from_address, `%${keyword}%`),
      like(emails.recipient, `%${keyword}%`)
    );
...
emailRoutes.get("/:id/attachments/:attachmentId", async (c) => {
  ...
  const attachment = await db.select().from(attachments).where(and(
    ...
    eq(attachments.email_id, emailId)
  )).get();
...
emailRoutes.get("/:id", async (c) => {
  ...
  const attachments2 = await db.select().from(attachments).where(eq(attachments.email_id, c.req.param("id"))).all();
  return c.json({
    item: {
      ...item,
...
emailRoutes.delete("/", async (c) => {
  ...
  const attachmentRows = await db.select({
    object_key: attachments.object_key
  }).from(attachments).where(inArray(attachments.email_id, ids)).all();
...
emailRoutes.delete("/:id", async (c) => {
  const db = drizzle(c.env.DB, { schema: schema_exports });
  const emailId = c.req.param("id");
  const item = await db.select().from(emails).where(eq(emails.id, emailId)).get();
  if (!item) return c.json({ error: "Email not found." }, 404);
  const attachmentRows = await db.select({
    object_key: attachments.object_key
  }).from(attachments).where(eq(attachments.email_id, emailId)).all();
  await db.delete(emails).where(eq(emails.id, emailId)).run();
  if (attachmentRows.length > 0) {
    try {
      await c.env.ATTACHMENTS.delete(attachmentRows.map((row) => row.object_key));
